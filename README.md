# tud-awe-workshop
Welcome to the workshop as part of the Airborne Wind Energy (AWE) course (AE4T40) of Delft University of Technology. Af the end of this workshop, students should be able to:
...
### Optional: using Jupyter Notebook offline
